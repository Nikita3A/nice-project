import { Controller, Get, Body, Param, Delete, UseGuards, Logger, ValidationPipe, UsePipes, ParseIntPipe, UseInterceptors, UploadedFile, Patch, Inject, CACHE_MANAGER, CacheInterceptor, CacheKey, CacheTTL } from '@nestjs/common';
...
export class UsersController {
  ...
  @Get('/:id')
  async findById(@Param('id', ParseIntPipe) id): Promise<User> {
